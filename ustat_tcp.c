...
int ntcp_established_print(int fd, struct ustat_module* m, const char* s,
                           size_t l) {
...
int ntcp_closing_print(int fd, struct ustat_module* m, const char* s,
                       size_t l) {
...
int ntcp6_established_print(int fd, struct ustat_module* m, const char* s,
                            size_t l) {
...
int ntcp6_closing_print(int fd, struct ustat_module* m, const char* s,
                        size_t l) {
    return _print(fd, _tcp6_counters[TCP_CLOSING]);
}

int ntcp6_listen_print(int fd, struct ustat_module* m, const char* s,
                       size_t l) {
    return _print(fd, _tcp6_counters[TCP_LISTEN]);
}

int ntcp4_established_print(int fd, struct ustat_module* m, const char* s,
                            size_t l) {
...
int ntcp4_closing_print(int fd, struct ustat_module* m, const char* s,
                        size_t l) {
    return _print(fd, _tcp4_counters[TCP_CLOSING]);
}

int ntcp4_listen_print(int fd, struct ustat_module* m, const char* s,
                       size_t l) {
