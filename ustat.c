...
extern int mem_total_human_print(int, struct ustat_module*, const char*,
                                 size_t);
...
extern int ntcp_established_print(int, struct ustat_module*, const char*,
                                  size_t);
...
extern int ntcp6_established_print(int, struct ustat_module*, const char*,
                                   size_t);
...
extern int ntcp4_established_print(int, struct ustat_module*, const char*,
                                   size_t);
...
extern int color8_fg_normal_print(int, struct ustat_module*, const char*,
                                  size_t);
extern int color8_fg_bright_print(int, struct ustat_module*, const char*,
                                  size_t);
extern int color8_bg_normal_print(int, struct ustat_module*, const char*,
                                  size_t);
extern int color8_bg_bright_print(int, struct ustat_module*, const char*,
                                  size_t);
...
static struct ustat_module modules[] = {
    ...
    {"bat+h", "battery charging, human", 0, 0, 0, bat_init,
     bat_charging_human_print},
                ...
                if (!modules[j].ready) {
                    ...
                    if (rc == 0) {
                        const char error_cant_init_module[] =
                            "\nerror init module \"";
                        write(STDERR_FILENO, error_cant_init_module,
                              sizeof(error_cant_init_module));
                        write(STDERR_FILENO, modules[j].name,
                              str_len(modules[j].name));
                        os_exit(1, "\"");
                    }
                }
                break;
