...
static int color8_print(int fd, char c, int offset) {
    ...
    static const char* color8[] = {
        "\x1b[30m",   "\x1b[30;1m", "\x1b[40m",   "\x1b[40;1m", "\x1b[31m",
        "\x1b[31;1m", "\x1b[41m",   "\x1b[41;1m", "\x1b[32m",   "\x1b[32;1m",
        "\x1b[42m",   "\x1b[42;1m", "\x1b[33m",   "\x1b[33;1m", "\x1b[43m",
        "\x1b[43;1m", "\x1b[34m",   "\x1b[34;1m", "\x1b[44m",   "\x1b[44;1m",
        "\x1b[35m",   "\x1b[35;1m", "\x1b[45m",   "\x1b[45;1m", "\x1b[36m",
        "\x1b[36;1m", "\x1b[46m",   "\x1b[46;1m", "\x1b[37m",   "\x1b[37;1m",
        "\x1b[47m",   "\x1b[47;1m",
    };
...
int color8_fg_normal_print(int fd, struct ustat_module* m, const char* s,
                           size_t l) {
    return color8_print(fd, s[l - 1], 0);
}

int color8_fg_bright_print(int fd, struct ustat_module* m, const char* s,
                           size_t l) {
    return color8_print(fd, s[l - 1], 1);
}

int color8_bg_normal_print(int fd, struct ustat_module* m, const char* s,
                           size_t l) {
    return color8_print(fd, s[l - 1], 2);
}

int color8_bg_bright_print(int fd, struct ustat_module* m, const char* s,
                           size_t l) {
...
static int xterm256_print(int fd, struct ustat_module* m, const char* s,
                          size_t l, const char* mode, size_t ml) {
